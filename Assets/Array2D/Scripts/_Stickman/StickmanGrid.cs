...
namespace _Main._Stickman.StickmanGrid
{
    ...
    public class StickmanGrid : MonoBehaviour
    {
        ...
        public void PlaceStickman(int x, int y, Stickman stickman)
        {
            if (_stickmanGrid[x, y] == null)
            {
                _stickmanGrid[x, y] = stickman;
                _tileGrid.GetTile(x, y).PlaceStickman(stickman);
            }
        }

        public void RemoveStickman(int x, int y)
        {
            if (_stickmanGrid[x, y] != null)
            {
                _stickmanGrid[x, y] = null;
                _tileGrid.GetTile(x, y).RemoveStickman();
            }
        }
        ...
        public bool AreNeighborsEmpty(int x, int y)
        {
            return _tileGrid.AreNeighborsEmpty(x, y);
        }
    }
}
